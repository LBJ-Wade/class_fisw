...
/* fisw: enum for ncdm fi_sw flag */
enum fisw_case_flags {fi, sw, fisw, none};
enum fisw_fi_dec_scat_flags {dec, scat, decscat};
...
struct background
{
  ...
  int fisw_case;        /**< Type of FI/SW model */
  int fisw_fi_dec_scat; /**< Type of FI model (decay or scattering) */
  double fisw_mA_fi;    /**< Daughter mass for FI in GeV */
  double fisw_mB_fi;    /**< Mother mass for FI in GeV */
  double fisw_gB_fi;    /**< DOF of the mother particle for FI */
  double fisw_Gam_fi;   /**< Decay width B->A DM in GeV for FI */
  double fisw_gstar_fi; /**< Number of relativistic DOF at the time of FI */
  double fisw_mA_sw;    /**< Daughter mass for SW in GeV */
  double fisw_mB_sw;    /**< Mother mass for SW in GeV */
  double fisw_gB_sw;    /**< DOF of the mother particle for SW */
  double fisw_Gam_sw;   /**< Decay width B->A DM in GeV for SW */
  double fisw_gstar_sw; /**< Number of relativistic DOF at the time of SW */
  double fisw_YFO_sw;   /**< Total mother relic comoving number density for SW */
